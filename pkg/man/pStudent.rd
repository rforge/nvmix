...
\usage{
pStudent(upper, lower = rep(-Inf, length(upper)), loc = rep(0, length(upper)), scale, df, standardized = FALSE,
       gam = 3.3, abstol = 0.001, Nmax = 1e8, B = 12, n_init = 2^6, precond = TRUE,
       method = "sobol")
}
\arguments{
  \item{upper}{vector of length \eqn{d}.}
  \item{lower}{vector of length \eqn{d}.}
  \item{loc}{location vector of length \eqn{d}. If \code{df > 1}, this is the mean of the distribution.}
