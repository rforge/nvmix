...
positive definite and $P(W=0)=0$. In this case one can 
...
of the form
$$	F(\mathbf{a},\mathbf{b} )=P(\mathbf{a} < \mathbf{X}\le\mathbf{b})=P(a_1 < X_1\le b_1,\dots, a_d < X_d\le b_d),\quad \mathbf{a},\mathbf{b}\in\mathbb{R}^d, $$
